...
## Ghi chú thêm
- Khó khăn gặp phải: Phân biệt rõ threat và vulnerability.
- Cách em xử lý: Đọc lại định nghĩa và áp dụng vào bối cảnh hệ thống điểm.
- Điều em học được từ bài lab: Cách sử dụng GitHub và hiểu rõ nguyên tắc CIA.